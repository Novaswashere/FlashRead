...
```bash
python3 skills/ui-ux-pro/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 skills/ui-ux-pro/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 skills/ui-ux-pro/scripts/search.py "<keyword>" --stack <stack>
```
...
```bash
python3 skills/ui-ux-pro/scripts/search.py "atlantafx primer enterprise theme" --stack javafx
python3 skills/ui-ux-pro/scripts/search.py "enterprise tableview density permission" --stack javafx
```
...
```bash
python3 skills/ui-ux-pro/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python3 skills/ui-ux-pro/scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python3 skills/ui-ux-pro/scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python3 skills/ui-ux-pro/scripts/search.py "list performance navigation" --stack react-native
```
...
- 默认图标库使用 **Phosphor (`@phosphor-icons/react`)**。`src/ui-ux-pro/data/icons.csv` 中列出的只是常用推荐图标，不是完整集合。
- 当推荐表中找不到合适的图标时：
